...
(function() {
    ...
    (function() {
        ...
        function updateMenu() {
            ...
            // Десктопная версия – фиксированный набор из 9 пунктов
        ...
        function buildDesktopMenuFixed() {
            ...
            // Видимые пункты (9) – добавили "Партнёры" после "Вопросы"
            const visibleNames = [
                'Главная', 'О нас', 'Краеведение', 'Новинки',
                'Услуги', 'События', 'Вопросы', 'Партнёры', 'Контакты'
            ];
            ...
            items.forEach(li => {
                ...
                if (visibleNames.includes(text)) {
                    ...
                    // Все остальные (Библиотеки района, Спидкубинг, Фотогалерея, Электронные ресурсы, Литературный календарь) уходят в "Ещё"
