...
(function() {
    ...
    // === КНОПКА «НАВЕРХ» (в этой версии её нет – работала через CSS) ===
    // В первоначальной версии кнопка управлялась только CSS, JS её не трогал.
    // Если кнопка не работала, значит, проблема была в CSS, а не в JS.
